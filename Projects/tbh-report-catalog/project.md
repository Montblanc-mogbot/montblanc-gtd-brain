...
- [ ] #nextaction #project/tbh-report-catalog Provide a **GLDT export** (CSV) for a single month window (same window as dispatch/AR run, e.g. 2025-01) including: posting date, batch date/num/seq (if present), journal id, account, debit, credit, amount, reference fields.
