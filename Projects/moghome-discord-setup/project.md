# Project: Moghome — Discord server setup (admin + structure)
...
## Notes / Context
- Tools: I can create/edit/delete categories/channels once the bot has permissions.
- Since it’s just us, full admin is acceptable; we can downgrade later if desired.
